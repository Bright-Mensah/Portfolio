...
<head>
    ...
    <title>Bright Mensah's Portfolio</title>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="assets/img/secondCod.jpg">
        ...
        <nav id="primary-navigation" class="site-navigation">
            <div class="container">
                <div class="navbar-header page-scroll">
                    ...
                    <!-- <a href="#hero" class="site-logo"><img src="code.jpg" alt="logo"></a>  -->
